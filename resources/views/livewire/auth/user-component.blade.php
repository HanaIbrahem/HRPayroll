<div>
  ...
  <x-form.container title="Register User">
    <form wire:submit.prevent="save" class="grid grid-cols-1 md:grid-cols-12 gap-6">
      ...
      <x-form.field class="md:col-span-6" title="Password" for="password" required>
        <input type="password" wire:model="password"
          class="input input-bordered w-full @error('password') input-error border-error @enderror"
          placeholder="••••••••" autocomplete="new-password" />
      </x-form.field>

      <x-form.field class="md:col-span-6" title="Confirm Password" for="password_confirmation" required>
