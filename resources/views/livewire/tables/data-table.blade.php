    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
            <label class="input input-bordered input-sm flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 opacity-70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <button class="btn btn-sm mx-3 btn-success join-item" wire:click="export('xlsx')">
            {{-- Excel icon --}}
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="currentColor"><path d="M4 4a2 2 0 0 1 2-2h7l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4z"/><path d="M14 2v4a1 1 0 0 0 1 1h4"/></svg>
            Excel
        </button>
        <button class="btn btn-error mx-2 btn-sm join-item" wire:click="export('pdf')">
            {{-- PDF icon --}}
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="currentColor"><path d="M6 2h7l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z"/><path d="M14 2v4a1 1 0 0 0 1 1h4"/><path d="M8 14h2a2 2 0 0 0 0-4H8v4zM13 10h2a2 2 0 1 1 0 4h-2v-4zM13 10v4M8 10v4"/></svg>
            PDF
        </button>
    </div>
                ...
                <table class="table table-sm table-zebra w-full">
                    <thead class="bg-base-100  top-0 z-10">
                        <tr>
                            ...
                            <th class="px-3 py-2 whitespace-nowrap text-xs font-semibold text-base-content/70">Actions</th>
                        </tr>
                            ...
                            <tr>
                                ...
                                <td class="px-3 py-2 whitespace-nowrap">
                                    <div class="flex items-center gap-1">
                                        @if ($editUrl)
                                            <a href="{{ $editUrl }}" wire:navigate class="btn btn- btn-xs">Edit</a>
                                        @else
                                        ...
                                        @if (!is_null($isActive))
                                            <button
                                                class="btn btn-xs {{ $isActive ? 'btn-error' : 'btn-success' }}"
