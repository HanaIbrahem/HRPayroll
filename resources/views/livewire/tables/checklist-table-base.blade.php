                            ...
                            <td class="px-3 py-2 whitespace-nowrap hidden sm:table-cell">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <a wire:navigate href="{{ route('checklist.edit', $r->id) }}"
                                        class="btn btn-ghost btn-xs {{ $canEdit ? '' : 'pointer-events-none opacity-40' }}"
                                        title="Edit">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <path
                                                d="M4 17.25V21h3.75L17.81 10.94l-3.75-3.75L4 17.25zM20.71 7.04a1.003 1.003 0 0 0 0-1.42l-2.34-2.34a1.003 1.003 0 0 0-1.42 0l-1.83 1.83 3.75 3.75 1.84-1.82z" />
                                        </svg>
                                    </a>

                                    <!-- Close -> Pending -->
                                    <button
                                        class="btn btn-ghost btn-xs {{ $canClose ? '' : 'pointer-events-none opacity-40' }}"
                                        title="Close (→ Pending)"
                                    ...
                                    <!-- Delete -->
                                    <button
                                        class="btn btn-ghost btn-xs text-error {{ $canDelete ? '' : 'pointer-events-none opacity-40' }}"
                                        title="Delete"
